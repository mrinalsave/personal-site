...
date: 2026-03-21
category: devlog
tags: [devlog, games, catalog]
summary: cataloging my games through a recreation of the Nintendo Switch UI
---

*[─=≡Σ((( つ•̀ω•́)つ take me to the page !](/nintendo-games/)*
...
- (home) maximum of 12 games displayed
- (home, all software) first game is auto-selected
- (home, all software) on game selection:
  - title listed above
  - white and blue border
  - icon brought into focus
- (all software) navigating back to "home" persists last icon selection
...
not a lot to say here — in retrospect, a lot of my time went to seemingly small visual adjustments. i definitely had a hard time with getting the elements to line up the way i wanted. but i still had a really great time making this! i think it looks pretty darn close to the actual Switch UI. (≧▽≦ﾉﾉﾞ☆

key takeaways:

- consider mobile-first development
