...
i've always thought fondly of the Windows Media Player animations and thought it would be fun to recreate that. i looked into it a bit more and found out that those animations were generated using a plugin called 'milkdrop', which uses a combination of audio analysis and procedural generation to create the visuals. as i researched this, i also realized that i was seeing it with rose-tinted glasses — the actual visuals were actually kind of ugly... (i am so sorry, Windows)
